...
The class below represents a document in the couchDB database called movies. 
...
Configure couchDB
 ...
 movie.config(token)
Note: you need the leanback rubygem for this line hash = Couchdb.login(@couchdb_username,@couchdb_password) 
