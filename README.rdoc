...
==Usage
 ...
 #name of the class must be singular to a Couchdb database 
 #the class below represents a document in the movies database
 ...
 #update a model on the database, requires that the document ID is included in the data
